...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'comms', label: 'Agent Comms', icon: <ChannelsIcon />, priority: true, essential: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'council', label: 'R&D Council', icon: <CouncilIcon />, priority: true, essential: true },
...
function CouncilIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M6.5 4.5L4.5 8.5M9.5 4.5L11.5 8.5M5 11h6" />
    </svg>
  )
}
