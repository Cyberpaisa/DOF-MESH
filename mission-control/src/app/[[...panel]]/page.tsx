...
import { RDCouncilPanel } from '@/components/panels/rd-council-panel'
...
function ContentRouter({ tab }: { tab: string }) {
  ...
  switch (tab) {
    ...
    case 'council':
      return <RDCouncilPanel />
    case 'comms':
      return (
        <div className="rounded-lg border border-border bg-card overflow-hidden h-[calc(100vh-8rem)]">
          <AgentCommsPanel />
        </div>
      )
    case 'chat':
