    ...
    def kickoff(self):
        ...
        for s in self._steps:
            output_parts.append(
                ...
                f"Recommendation: implement, execute, and deploy the next step as defined in the task. "
                f"Action required: configure {keyword_context}, validate results, and monitor for regressions. "
                f"Steps: (1) review {keyword_context} criteria, (2) implement changes, (3) test and verify output. "
